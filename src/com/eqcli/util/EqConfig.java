...
public class EqConfig {
	...
	public  static String authenCode = "PASSWORD";  		//认证密码
	public  static int longitude = random.nextInt(300)*100000;				//经度 度＊100000
	public  static int latitude = random.nextInt(300)*100000;				//纬度 度＊100000
	...
	public static String defaultSrv = "TT";   //台网服务端代号
